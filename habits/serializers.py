...
from habits.validators import ExcludeValidator, LeadTimeValidator, RelatedNiceValidator, NiceValidator, \
    FrequencyValidator
...
class HabitSerializer(ModelSerializer):
    class Meta:
        ...
        validators = [
            ...
            NiceValidator(field1='is_nice', field2='related_habit', field3='remuneration'),
